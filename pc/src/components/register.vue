    ...
    >
      <div class="reg_cont">
        <!-- <div class="reg_left">
                    <div class="reg_tip">
                        <div class="tip_text"
                            style="font-size: 24px;font-weight: bold;margin-bottom: 20px;display: flex;justify-content: center;width: 100%;">
                            <span v-if="httpUrls.appletId == 3">无忧秘书</span>
                            <span v-if="httpUrls.appletId == 3"
                                style="backgroundImage: linear-gradient(30deg,#1F64FF 35%,#97b7ff 45%,#1F64FF 60%);WebkitTextFillColor: #0000;backgroundClip: text;WebkitBackgroundClip: text;fontWeight: 700;width: max-content">AI</span>
                            <span v-if="httpUrls.appletId != 3">慧远</span>
                            <span v-if="httpUrls.appletId != 3"
                                style="backgroundImage: linear-gradient(30deg,#1F64FF 35%,#97b7ff 45%,#1F64FF 60%);WebkitTextFillColor: #0000;backgroundClip: text;WebkitBackgroundClip: text;fontWeight: 700;width: max-content">文创</span>
                            <span>人工智能平台</span>
                        </div>
                    </div>
                    ...
                    <div class="reg_tip" style="margin-bottom: 0;">
                        <div class="tip_text">
                            <div class="background_blue">
                                <img class="tip_img" style="margin-right: 10px;" src="../assets/images/dian.png" alt="">
                                聊天
                            </div>
                            <div class="background_blue">
                                <img class="tip_img" style="margin-right: 10px;" src="../assets/images/dian.png" alt="">
                    ...
                    <div class="reg_zw"></div>

                    <div class="left_img">
                        <img class="bot_img" src="../assets/images/reg.png" alt="">
                    </div>
                </div> -->
  ...
  methods: {
    ...
    queryImageCode() {
      if (this.iamgeCode == 1) {
        ...
        let val = { mobile: this.regPhone,action:"web",Ticket:this.ticket,Randstr:this.randstr };
